...
const translationPacks = {
  en: {
    ...
    summary: {
      ...
      notReportedToday: 'Not checked in today',
      unreadWorkerMessages: 'Unread from workers',
    },
    reports: {
  ...
  ja: {
    ...
    summary: {
      ...
      notReportedToday: '本日未報告',
      unreadWorkerMessages: '未読の作業員連絡',
    },
    reports: {
  ...
  vi: {
    ...
    summary: { activeOrders: 'Tích cực', completionRate: 'Tiến độ', inProgress: 'Đang làm', delayed: 'Trễ', readyForDispatch: 'Sẵn sàng', outstandingStarts: 'Chưa làm', notReportedToday: 'Chưa báo cáo hôm nay', unreadWorkerMessages: 'Tin chưa đọc từ công nhân' },
  ...
  tl: {
    ...
    summary: { activeOrders: 'Aktibo', completionRate: 'Rate', inProgress: 'Ginagawa', delayed: 'Naantala', readyForDispatch: 'Handa', outstandingStarts: 'Hindi', notReportedToday: 'Hindi pa nag-check-in ngayon', unreadWorkerMessages: 'Hindi pa nabasang mensahe' },
  ...
  id: {
    ...
    summary: { activeOrders: 'Aktif', completionRate: 'Tingkat', inProgress: 'Sedang dikerjakan', delayed: 'Tertunda', readyForDispatch: 'Siap', outstandingStarts: 'Belum', notReportedToday: 'Belum lapor hari ini', unreadWorkerMessages: 'Pesan belum dibaca dari pekerja' },
  ...
  my: {
    ...
    summary: { activeOrders: 'လက်ရှိလုပ်ငန်းများ', completionRate: 'နှုန်း', inProgress: 'ဆောင်ရွက်ဆဲ', delayed: 'ကြန့်ကြာသည်', readyForDispatch: 'အသင့်', outstandingStarts: 'မစတင်', notReportedToday: 'ယနေ့မှတ်တမ်းမတင်ရသေး', unreadWorkerMessages: 'မဖတ်ရသေးသောစာများ' },
